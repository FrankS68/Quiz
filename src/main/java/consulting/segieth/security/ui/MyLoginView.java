...
public class MyLoginView extends VerticalLayout {
    ...
    public MyLoginView() {
        ...
        Anchor facebookLoginLink = new Anchor("/oauth2/authorization/facebook", "Mit Facebook anmelden");
        facebookLoginLink.getElement().setAttribute("router-ignore", true);
        
        add(new H1("Willkommen"), facebookLoginLink);
